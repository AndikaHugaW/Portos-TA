...
<html lang="en">
          ...
          <div class="row">
            <div class="row align-items-center mt-2 pt-2 mx-5">
              ...
              <div class="container">
                ...
                <div class="col d-flex" style="margin-top: 200px; margin-left: -50px;">
                  <h3 class="text-start fw-bold text-white mt-4">Portofolio Siswa</h3>
                  <h6 class="fw-bold alert-link text-white mt-4" style="margin-left: 970px; margin-top: 8px;">Lihat semua</h6>
                </div>
  ...
  <div class="" style="">
    <h2 class="fw-bold" style="margin-left: 50px; margin-top: 100px;">Jurusan Yang Ada Di SMK RUS</h2>
