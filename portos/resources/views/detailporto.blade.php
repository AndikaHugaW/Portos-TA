...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}plugins/css/all.css">
    <link rel="stylesheet" href="{{asset('/')}}plugins/js/all.js">
    <!-- Bootstrap CSS -->
  ...
  <body style="background-color: #F6F7F9;">
    <a class="nav-link fw-bold button-navbar" style="font-size: 20px; font-family: poppins; padding-top: 30px; padding-left: 30px" href="{{ route('back') }}"><img src="/Vector.svg" style="width: 20px; height: 20px" alt=""></a>
        <div class="container">
        <div class="row row-cols-auto justify-item-center position-absolute top-50 start-50 translate-middle"></div>
            <img src="/profile-3.jpg" class="rounded-circle" style="width: 100px; height: 100px;" alt=""><a href=""></a>
    ...
    <div class="justify-item-center position-absolute top-50 start-50 translate-middle" style="margin-top: 300px;">
      ...
      <div class="">
        <p class="fw-semibold" style="width: 500px; font-size: 18px; margin-top: 80px; margin-bottom: 10px; font-family: 'Poppins';">Nama : {{$users->name}}</p>
      ...
      <div class="ms-auto" style="margin-top: 10px; margin-bottom: 30px">
        <a href="{{ $users->twitter }}" class="text-decoration-none fw-semibold" style="font-family: Poppins; color:#FFBE55">Twitter</a>
        <a href="{{ $users->instagram }}" class="text-decoration-none fw-semibold" style="font-family: Poppins; margin-left: 10px; color:#FFBE55">Instagram</a>
        <a href="{{ $users->facebook }}" class="text-decoration-none fw-semibold" style="font-family: Poppins; margin-left: 10px; color:#FFBE55">Facebook</a>
      </div>
    </div>
{{--
